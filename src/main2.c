...
int main(int argc, char *argv[])
{
	...
	*/
	...
	// Initialize squirrels, cells and global clock with their starting data.
	initSimulationData();
	
	// Set function pointers for actors and other necessary variables to the actor framework.
	initFramework();
